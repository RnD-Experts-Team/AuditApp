...
class UserPermissionGrantedHandler implements EventHandlerInterface
{
    public function handle(array $event): void
    {
        ...
        DB::transaction(function () use ($userId, $permissionNames) {
            ...
            // IMPORTANT: IDs must match => permissions MUST already exist from permission.created / role.created snapshot.
            ...
            // Now safe: it will attach existing permission rows (correct IDs).
